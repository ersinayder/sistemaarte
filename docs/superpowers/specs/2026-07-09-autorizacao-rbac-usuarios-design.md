...
- `users.role` segue como dado estrutural legado para regras de disponibilidade administrativa; `profile_key` segue como perfil efetivo de permissao. Criacao/atribuicao de perfis customizados depende de uma fase propria para resolver essa separacao sem gambiarras.
