import{c as I,u as L,b as F,r as l,a as j,z as c,j as e,R as U}from"./index-6lF32MGt.js";function _(t){const d=localStorage.getItem("oficina_nome")||"Arte & Molduras",x=localStorage.getItem("oficina_end")||"",m=localStorage.getItem("oficina_tel")||"",g=t.valorrestante!==void 0?t.valorrestante:Number(t.valor||t.valortotal||0)-Number(t.entrada||t.valorentrada||0),r=v=>`R$ ${Math.abs(Number(v)||0).toFixed(2).replace(".",",").replace(/(\d)(?=(\d{3})+(?!\d))/g,"$1.")}`,f=v=>v?new Date(v+"T12:00:00").toLocaleDateString("pt-BR"):"—",u={Recebido:"#006494","Em Produção":"#da7101",Pronto:"#01696f",Entregue:"#437a22",Cancelado:"#888"}[t.status]||"#333",p=window.open("","_blank","width=600,height=900");p.document.write(`<!DOCTYPE html>
<html lang="pt-BR">
<head>
<meta charset="UTF-8">
