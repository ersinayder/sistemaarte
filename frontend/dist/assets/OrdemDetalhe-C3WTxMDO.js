import{c as W,u as I,b as L,r as l,a as j,z as c,j as e,R as F}from"./index-CdEmshiZ.js";function U(t){const d=localStorage.getItem("oficina_nome")||"Arte & Molduras",x=localStorage.getItem("oficina_end")||"",m=localStorage.getItem("oficina_tel")||"",g=t.valorrestante!==void 0?t.valorrestante:Number(t.valor||t.valortotal||0)-Number(t.entrada||t.valorentrada||0),r=v=>`R$ ${Math.abs(Number(v)||0).toFixed(2).replace(".",",").replace(/(\d)(?=(\d{3})+(?!\d))/g,"$1.")}`,f=v=>v?new Date(v+"T12:00:00").toLocaleDateString("pt-BR"):"—",u={Recebido:"#006494","Em Produção":"#da7101",Pronto:"#01696f",Entregue:"#437a22",Cancelado:"#888"}[t.status]||"#333",p=window.open("","_blank","width=600,height=900");p.document.write(`<!DOCTYPE html>
<html lang="pt-BR">
<head>
<meta charset="UTF-8">
...
</html>`),p.document.close(),p.focus(),setTimeout(()=>p.print(),600)}const S=t=>"R$ "+Number(t||0).toFixed(2).replace(".",",").replace(/\B(?=(\d{3})+(?!\d))/g,"."),A=t=>t?new Date(t).toLocaleString("pt-BR"):"—",M=t=>t?new Date(`${t}T12:00:00`).toLocaleDateString("pt-BR"):"—",H=()=>new Date(Date.now()-3*60*60*1e3).toISOString().slice(0,10),w=["Recebido","Em Produção","Pronto","Entregue"],G={Recebido:"recebido","Em Produção":"emproducao",Pronto:"pronto",Entregue:"entregue",Cancelado:"cancelado"},i={Recebido:"var(--color-blue)","Em Produção":"var(--color-orange)",Pronto:"var(--color-primary)",Entregue:"var(--color-success)",Cancelado:"var(--color-text-faint)"},V={Pix:"pix",Dinheiro:"dinheiro",Credito:"credito",Debito:"debito",Link:"link","A cobrar":"normal"},J={Credito:"Crédito",Debito:"Débito",Link:"Link Pag.","A cobrar":"A cobrar"};function X(){const{id:t}=W(),d=I(),{isCaixa:x,isAdmin:m,isOficina:g}=L(),[r,f]=l.useState(null),[z,u]=l.useState([]),[p,v]=l.useState(!0),[b,C]=l.useState(""),[$,k]=l.useState(!1),[B,h]=l.useState(!1),y=l.useCallback(async()=>{try{const a=await j.get(`/ordens/${t}`);f(a.data),u(a.data.logs||[])}catch{c.error("Erro ao carregar OS"),d("/ordens")}finally{v(!1)}},[t,d]);l.useEffect(()=>{y()},[y]);const O=async a=>{var o,s;try{await j.patch(`/ordens/${t}/status`,{status:a}),c.success(`Status → ${a}`),y()}catch(n){c.error(((s=(o=n.response)==null?void 0:o.data)==null?void 0:s.error)||"Erro ao atualizar status")}},N=async()=>{if(b.trim()){k(!0);try{await j.patch(`/ordens/${t}/status`,{status:r.status,obs:b}),C(""),c.success("Observação adicionada!"),y()}catch{c.error("Erro ao adicionar observação")}finally{k(!1)}}},R=async()=>{var a,o;try{await j.delete(`/ordens/${t}`),c.success(`OS ${r.numero} excluída — lançamentos e histórico removidos.`),d("/ordens")}catch(s){c.error(((o=(a=s.response)==null?void 0:a.data)==null?void 0:o.error)||"Erro ao excluir OS"),h(!1)}};if(p)return e.jsx("div",{className:"loading-center",children:e.jsx("div",{className:"spinner"})});if(!r)return null;const T=r.valor_restante!==void 0?r.valor_restante:(r.valor||0)-(r.entrada||0),D=r.prazo&&r.prazo<H()&&!["Entregue","Cancelado"].includes(r.status),E=w.indexOf(r.status),P=(x||g)&&r.status!=="Entregue"&&r.status!=="Cancelado";return e.jsxs("div",{children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-3)",marginBottom:"var(--space-5)"},children:[e.jsxs("button",{className:"btn btn-ghost btn-sm",onClick:()=>d("/ordens"),children:[e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:e.jsx("path",{d:"M15 18l-6-6 6-6"})}),"Ordens"]}),e.jsx("span",{style:{color:"var(--color-text-faint)"},children:"/"}),e.jsx("span",{style:{fontWeight:700,color:"var(--color-primary)"},children:r.numero}),e.jsx("span",{className:`badge badge-${G[r.status]}`,children:r.status}),r.prioridade==="Urgente"&&e.jsx("span",{className:"badge badge-urgente",children:"⚡ Urgente"}),D&&e.jsx("span",{className:"badge",style:{background:"var(--color-error-hl)",color:"var(--color-error)"},children:"⚠ Prazo vencido"}),e.jsx("div",{style:{flex:1}}),e.jsxs("button",{className:"btn btn-ghost btn-sm",onClick:()=>U(r),children:[e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("path",{d:"M6 9V2h12v7M6 18H4a2 2 0 01-2-2v-5a2 2 0 012-2h16a2 2 0 012 2v5a2 2 0 01-2 2h-2"}),e.jsx("path",{d:"M6 14h12v8H6z"})]}),"Imprimir OS"]}),m&&e.jsxs("button",{className:"btn btn-sm",onClick:()=>h(!0),style:{color:"var(--color-error)",border:"1px solid var(--color-error)",background:"transparent"},children:[e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:e.jsx("path",{d:"M3 6h18M8 6V4h8v2M19 6l-1 14H6L5 6"})}),"Excluir OS"]})]}),e.jsxs("div",{className:"card card-pad",style:{marginBottom:"var(--space-4)"},children:[e.jsx("div",{style:{fontWeight:700,fontSize:"var(--text-xs)",color:"var(--color-text-muted)",textTransform:"uppercase",letterSpacing:"0.05em",marginBottom:"var(--space-4)"},children:"Progresso"}),e.jsx("div",{style:{display:"flex",alignItems:"center",gap:0,marginBottom:"var(--space-4)",overflowX:"auto",paddingBottom:"var(--space-2)"},children:w.map((a,o)=>{const s=o<E||r.status==="Entregue"&&o<=E,n=a===r.status,_=s||n;return e.jsxs(F.Fragment,{children:[e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:"var(--space-2)",minWidth:80},children:[e.jsx("div",{style:{width:36,height:36,borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",background:n?i[a]:s?"var(--color-success)":"var(--color-surface-dynamic)",color:_?"white":"var(--color-text-faint)",fontWeight:700,fontSize:"var(--text-sm)",border:n?`2px solid ${i[a]}`:s?"2px solid var(--color-success)":"2px solid var(--color-border)",transition:"all 0.3s ease",boxShadow:n?`0 0 0 4px color-mix(in oklab, ${i[a]} 20%, transparent)`:"none"},children:s&&!n?e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"3",children:e.jsx("polyline",{points:"20 6 9 17 4 12"})}):o+1}),e.jsx("span",{style:{fontSize:"var(--text-xs)",fontWeight:n?700:400,color:n?i[a]:"var(--color-text-muted)",textAlign:"center",whiteSpace:"nowrap"},children:a})]}),o<w.length-1&&e.jsx("div",{style:{flex:1,height:2,background:s?"var(--color-success)":"var(--color-border)",minWidth:24,margin:"0 4px",marginBottom:28}})]},a)})}),P&&e.jsxs("div",{style:{display:"flex",gap:"var(--space-2)",flexWrap:"wrap"},children:[w.map(a=>a!==r.status&&e.jsxs("button",{className:"btn btn-ghost btn-sm",style:{borderColor:i[a],color:i[a]},onClick:()=>O(a),children:["→ ",a]},a)),x&&r.status!=="Cancelado"&&e.jsx("button",{className:"btn btn-ghost btn-sm",style:{borderColor:"var(--color-text-faint)",color:"var(--color-text-faint)"},onClick:()=>O("Cancelado"),children:"Cancelar OS"})]})]}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 300px",gap:"var(--space-4)",marginBottom:"var(--space-4)"},children:[e.jsxs("div",{className:"card card-pad",children:[e.jsx("div",{style:{fontWeight:700,fontSize:"var(--text-sm)",marginBottom:"var(--space-4)"},children:"Detalhes da OS"}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"var(--space-3)"},children:[[["Cliente",r.cliente_nome],["Contato",r.cliente_contato||"—"],["Tipo",r.tipo],["Prioridade",r.prioridade],["Prazo",M(r.prazo)],["Criada em",A(r.criado_em)]].map(([a,o])=>e.jsxs("div",{children:[e.jsx("div",{style:{fontSize:"var(--text-xs)",color:"var(--color-text-muted)",marginBottom:2},children:a}),e.jsx("div",{style:{fontWeight:600,fontSize:"var(--text-sm)"},children:o})]},a)),e.jsxs("div",{style:{gridColumn:"1 / -1"},children:[e.jsx("div",{style:{fontSize:"var(--text-xs)",color:"var(--color-text-muted)",marginBottom:4},children:"Descrição"}),e.jsx("div",{style:{fontSize:"var(--text-sm)",lineHeight:1.6,background:"var(--color-surface-dynamic)",padding:"var(--space-3)",borderRadius:"var(--radius-md)"},children:r.descricao})]}),r.obs&&e.jsxs("div",{style:{gridColumn:"1 / -1"},children:[e.jsx("div",{style:{fontSize:"var(--text-xs)",color:"var(--color-text-muted)",marginBottom:4},children:"Observações"}),e.jsx("div",{style:{fontSize:"var(--text-sm)",lineHeight:1.6,background:"var(--color-surface-dynamic)",padding:"var(--space-3)",borderRadius:"var(--radius-md)"},children:r.obs})]})]})]}),e.jsxs("div",{className:"card card-pad",children:[e.jsx("div",{style:{fontWeight:700,fontSize:"var(--text-sm)",marginBottom:"var(--space-4)"},children:"Financeiro"}),[["Valor Total",S(r.valor),!1],["Entrada",S(r.entrada),!1]].map(([a,o])=>e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",padding:"var(--space-2) 0",borderBottom:"1px solid var(--color-divider)"},children:[e.jsx("span",{style:{fontSize:"var(--text-sm)",color:"var(--color-text-muted)"},children:a}),e.jsx("span",{className:"tabnum",style:{fontWeight:600},children:o})]},a)),e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",paddingTop:"var(--space-3)",marginTop:"var(--space-1)"},children:[e.jsx("span",{style:{fontWeight:700},children:"Saldo"}),e.jsx("span",{className:"tabnum",style:{fontWeight:800,color:T>0?"var(--color-warning)":"var(--color-success)",fontSize:"var(--text-base)"},children:S(T)})]}),e.jsxs("div",{style:{marginTop:"var(--space-4)",padding:"var(--space-2) 0",borderTop:"1px solid var(--color-divider)"},children:[e.jsx("div",{style:{fontSize:"var(--text-xs)",color:"var(--color-text-muted)",marginBottom:4},children:"Forma de Pagamento"}),e.jsx("span",{className:`badge badge-${V[r.pagamento]||"normal"}`,children:J[r.pagamento]||r.pagamento||"—"})]})]})]}),e.jsxs("div",{className:"card card-pad",children:[e.jsx("div",{style:{fontWeight:700,fontSize:"var(--text-sm)",marginBottom:"var(--space-4)"},children:"Histórico de Atividade"}),e.jsxs("div",{style:{position:"relative",paddingLeft:"var(--space-8)",marginBottom:"var(--space-5)"},children:[e.jsx("div",{style:{position:"absolute",left:11,top:0,bottom:0,width:2,background:"var(--color-border)"}}),z.length===0&&e.jsx("p",{style:{fontSize:"var(--text-xs)",color:"var(--color-text-faint)"},children:"Nenhuma atividade registrada."}),z.map((a,o)=>e.jsxs("div",{style:{position:"relative",marginBottom:"var(--space-4)"},children:[e.jsx("div",{style:{position:"absolute",left:"calc(-1 * var(--space-8) + 4px)",width:16,height:16,borderRadius:"50%",background:a.tipo==="status"?i[a.valor_novo]||"var(--color-primary)":"var(--color-surface-dynamic)",border:`2px solid ${a.tipo==="status"?i[a.valor_novo]||"var(--color-primary)":"var(--color-border)"}`}}),e.jsxs("div",{style:{fontSize:"var(--text-xs)",color:"var(--color-text-faint)",marginBottom:2},children:[A(a.criado_em)," · ",a.usuario_nome||"sistema"]}),e.jsx("div",{style:{fontSize:"var(--text-sm)",fontWeight:a.tipo==="obs"?400:600},children:a.tipo==="status"?e.jsxs("span",{children:["Status alterado: ",e.jsx("span",{style:{color:i[a.valor_anterior]||"inherit"},children:a.valor_anterior})," → ",e.jsx("span",{style:{color:i[a.valor_novo]||"inherit",fontWeight:700},children:a.valor_novo})]}):e.jsxs("span",{style:{color:"var(--color-text-muted)"},children:["📝 ",a.texto]})})]},a.id||o))]}),e.jsxs("div",{style:{borderTop:"1px solid var(--color-divider)",paddingTop:"var(--space-4)"},children:[e.jsx("div",{style:{fontWeight:600,fontSize:"var(--text-xs)",color:"var(--color-text-muted)",textTransform:"uppercase",letterSpacing:"0.05em",marginBottom:"var(--space-3)"},children:"Adicionar Observação"}),e.jsxs("div",{style:{display:"flex",gap:"var(--space-3)"},children:[e.jsx("input",{className:"form-input",placeholder:"Anote uma informação, atualização...",value:b,onChange:a=>C(a.target.value),onKeyDown:a=>a.key==="Enter"&&N(),style:{flex:1}}),e.jsx("button",{className:"btn btn-primary",onClick:N,disabled:$||!b.trim(),children:$?e.jsx("div",{className:"spinner",style:{width:14,height:14}}):"Adicionar"})]})]})]}),B&&e.jsx("div",{className:"modal-overlay",onClick:a=>a.target===a.currentTarget&&h(!1),children:e.jsxs("div",{className:"modal modal-sm",children:[e.jsx("div",{className:"modal-header",children:e.jsxs("span",{className:"modal-title",style:{color:"var(--color-error)"},children:["Excluir OS ",r.numero,"?"]})}),e.jsxs("div",{style:{padding:"var(--space-4) var(--space-5)",display:"flex",flexDirection:"column",gap:"var(--space-3)"},children:[e.jsxs("p",{style:{color:"var(--color-text-muted)",fontSize:"var(--text-sm)"},children:["Esta ação é ",e.jsx("strong",{children:"permanente e irreversível"}),". Serão removidos:"]}),e.jsxs("ul",{style:{fontSize:"var(--text-sm)",color:"var(--color-text-muted)",paddingLeft:"var(--space-5)",display:"flex",flexDirection:"column",gap:"var(--space-1)"},children:[e.jsxs("li",{children:["A Ordem de Serviço ",e.jsx("strong",{children:r.numero})," — ",r.clientenome]}),e.jsxs("li",{children:["Entrada automática no Caixa (",S(r.valorentrada??r.entrada??0),")"]}),e.jsx("li",{children:"Todos os lançamentos vinculados a esta OS"}),e.jsx("li",{children:"Todo o histórico de status"})]}),e.jsxs("p",{style:{fontSize:"var(--text-xs)",padding:"var(--space-2) var(--space-3)",background:"var(--color-warning-highlight)",borderRadius:"var(--radius-md)",color:"var(--color-warning)"},children:["💡 Para apenas encerrar a OS sem apagar o histórico financeiro, use o botão ",e.jsx("strong",{children:'"Cancelar OS"'}),"."]})]}),e.jsxs("div",{className:"modal-footer",children:[e.jsx("button",{className:"btn btn-ghost",onClick:()=>h(!1),children:"Cancelar"}),e.jsx("button",{className:"btn btn-danger",onClick:R,children:"Excluir permanentemente"})]})]})})]})}export{X as default};
